      ...
      <div className="recruitment_background">
        ...
        <div className="row gx-0 recruitment_content_container">
          ...
          <div
            className={
              showContentTwo
                ? "col-3 recruitment_info recruitment_show2"
                : "col-3 recruitment_info"
            }
            ref={contentTwoRef}
          >
            <div className="recruitment_info_container">
              <div className="recruitment_info_title">앱 개발자</div>
              <div className="divider"></div>
              <div
                className="recruitment_info_content_body"
                style={{ marginTop: 20 }}
              >
          ...
          <div
            className={
              showContentThree
                ? "col-3 recruitment_info recruitment_show3"
                : "col-3 recruitment_info"
            }
            ref={contentThreeRef}
          >
          ...
          >
            <div className="recruitment_info_container">
              <div className="recruitment_info_title">Business Developer</div>
              <div className="divider"></div>
              <div
                className="recruitment_info_content_body"
                style={{ marginTop: 20 }}
